...
function StyleCollectionCard({ style = {}, id }) {
  ...
  return (
    <div
      className="flex flex-col sm:flex-row relative w-auto h-auto animate-slideX"
      style={{
    ...
    >
      ...
      <div className="pt-10 ps-3 w-full sm:w-1/2">
        ...
        <button
          ...
          className="text-sm bg-snowWhite animate-circGrow transition-all text-richBlack px-5 py-1 mt-5"
