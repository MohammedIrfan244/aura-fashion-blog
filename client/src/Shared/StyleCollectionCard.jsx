    ...
    >
      ...
      <div className="pt-10 ps-3 w-full sm:w-1/2">
        <p className="flex items-center font-thin">
          FASHION {style?.isLiked ? <FaHeart className="text-red-500 text-base font-semibold ms-5 me-1 " /> : <FaRegHeart className="text-base font-semibold ms-5 me-1 " />}
          {style?.likeCount}
        </p>
        <motion.div 
        ...
        <p className="text-snowWhite mt-5 sm:mt-40 font-extralight text-sm">
          By <span className="font-semibold">&nbsp;{style?.author.toUpperCase()}</span>
        </p>
