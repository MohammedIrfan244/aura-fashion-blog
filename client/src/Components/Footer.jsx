...
function Footer() {
  ...
  return (
    <div className="h-80 md:h-96 w-screen lg:h-[450px] mt-20">
      ...
      >
        <div className="flex items-center space-x-5 sm:space-x-10 md:space-x-20 lg:space-x-24">
          <img
            ...
            alt="Aura logo"
          />
          <p className="text-richBlack text-3xl sm:text-4xl md:text-5xl font-windSong font-semibold">
            Wanna be a Creator ?
          </p>
        </div>
        <div
          onClick={() => navigate("/subscription")}
          className="w-10 hover:cursor-pointer h-10 sm:w-10 sm:h-10 md:w-16 md:h-16 rounded-full bg-electricBlue flex justify-center items-center"
        >
      ...
      >
        <p className="hidden sm:block sm:text-2xl md:text-3xl lg:text-4xl w-60">
          Elevate Your Fashion with Aura
        </p>
