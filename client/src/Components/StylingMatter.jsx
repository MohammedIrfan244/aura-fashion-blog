...
function StylingMatter() {
  return (
    <div className="mt-14 sm:mt-20 flex-col sm:flex-row flex justify-between items-center bg-[#242427]">
        <div className="w-[95%] h-[500px] sm:w-[30%] overflow-hidden">
   ...
   <ul className="mt-5 text-sm hidden sm:block space-y-5">
    <li><span className="font-semibold">Understand Your Fit</span> : Choose clothes that complement your body shape. Properly fitted garments enhance your silhouette and provide a polished look.</li>
    <li><span className="font-semibold">Consider Color Coordination</span> : Opt for colors that suit your skin tone and balance bold patterns with neutral pieces to avoid clashing.</li>
    <li><span className="font-semibold">Avoid Too Many Trends at Once</span> : Following every trend can make your outfit look chaotic. Incorporate trends subtly while sticking to your personal style.</li>
   </ul>
   </div>
   </div>
  )
