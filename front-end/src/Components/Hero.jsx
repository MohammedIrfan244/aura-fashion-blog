    ...
    <div className="w-screen flex flex-col sm:flex-row">
      <div className="w-full sm:w-1/2 h-screen flex">
        <div className="w-1/2 h-[99vh] justify-end items-center flex flex-col">
          <p
            style={{ writingMode: 'vertical-rl',"--tw-height-70":"400px","--tw-hieght-100":"400px",animationDuration:"700ms",textShadow:'2px 2px 4px rgba(0, 0, 0, 0.7)'}}
          ...
          <div className="w-56 h-56 rounded-full mb-5 animate-circGrow overflow-hidden shadow-lg shadow-black" style={{animationDuration:"500ms"}}>
            <img src="https://img.freepik.com/premium-photo/closeup-round-compact-blush-black-casing-showcasing-its-pink-shade-against-grey-gradient-background_574957-8935.jpg?w=826" className="object-cover scale-150 w-full h-full" alt="" />
          </div>
        </div>
        ...
        "animationDuration":"700ms"
            ...
            <div className="w-auto shadow-md h-auto relative hover:scale-[1.02] shadow-black hover:shadow-lg hover:shadow-black transition-all duration-300 ease-out border-2 border-snowWhite">
              <img src="https://img.freepik.com/free-photo/applying-red-lipstick-lips-close-up-photo-black-background-beauty-make-up_482257-10395.jpg?t=st=1729090464~exp=1729094064~hmac=b4526445bd14feb4c294474c31c643366b38a574d034301cf0586a51c4956282&w=360" alt="image" className="border-none"/>
              <AiFillTag className="absolute top-0 right-[93px]" />
            </div>
          </div>
        </div>
        <div className="font-beban tracking-widest">
        <p className="text-xl animate-widthGrow overflow-hidden h-5 transition-all" style={{"--tw-width-70":"200px","--tw-width-100":"200px",animationDuration:"500ms"}}>Craft Your Aesthetic</p>
        <p className="text-3xl flex items-center">Here <LuArrowBigDownDash className="text-electricBlue"/></p>
        </div>
        </div>
      </div>
